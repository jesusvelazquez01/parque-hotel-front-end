...
const PasajerosEdit = () => {
  ...
  useEffect(() => {
    ...
    setFormData(pasajeroEjemplo);
  }, [id]);

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Lógica para actualizar el pasajero
    console.log('Actualizando pasajero:', formData);
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div>
        <h1 className="text-2xl font-bold">Editar Pasajero</h1>
        <p className="text-gray-500 mt-1">Actualiza la información del pasajero</p>
      </div>
